...
| Low | Warning |  | ZAP errors logged - see the zap.log file for details | 234    |
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 269    |
| Low | Exceeded High | http://localhost:8001 | Percentage of responses with status code 4xx | 57 % |
| Low | Exceeded High | http://localhost:8001 | Percentage of responses with status code 5xx | 54 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 2xx | 24 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 3xx | 1 % |
